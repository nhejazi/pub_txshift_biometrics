...
sim_type <- "hvtn505_moderate"
source(here("R", "summary_helpers.R"))
...
# truth vs. delta table
sink(here("tables", "moderate_truths_hvtn.tex"))
rbind(as.integer(delta_shift), truths) %>%
  kable(format = "latex", digits = 4, label = "table:hvtn_moderate_truths",
